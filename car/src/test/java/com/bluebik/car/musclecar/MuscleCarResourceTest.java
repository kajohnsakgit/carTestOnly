...
public class MuscleCarResourceTest {
    ...
    public void setUp() throws Exception {
        Mockito.when(muscleCarService.getCar(1)).thenReturn(new MuscleCar(1 ,"1", "2", "3", "4"));
    ...
    public void addCarToList() throws Exception {
        ResponseEntity<Void> responseEntity = muscleCarResource.addCarToList(
            new MuscleCar(0  , "brand", "model", "power", "engine")
        );
    }
    ...
    public void updateCar() throws Exception {
        ResponseEntity<Void> responseEntity = muscleCarResource.updateCar(1, new MuscleCar(1 , "brand", "model", "power", "engine")
        );
    }
